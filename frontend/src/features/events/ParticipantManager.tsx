...
export default function ParticipantManager({
  ...
  const [isGuestModalOpen, setGuestModalOpen] =
    useState(false);
  ...
  const handleStatusChange = async (
    ...
    try {
      const updatedParticipant =
        await updateGameParticipationStatus(
          participant.id,
          status,
          participant.version,
        );
